...
export const SCHOLARSHIP_QUESTIONS = [
	{
		id: "healthConcerns",
		label: "Current underlying health issues or concerns",
	},
	{
		id: "painInjuries",
	...
	{
		id: "aboutYourself",
		label: "About her (who she is, everyday life, what she wants us to know)",
	},
	{
		id: "healthImpact",
		label: "Do her health issues stop her from showing up to day-to-day life",
	},
	{
		id: "consideredHowLong",
		label: "How long she has considered doing something, and what has stopped her",
	},
	{
		id: "biggestObstacle",
		label: "Her biggest obstacle to improving her health",
	},
	{
		id: "whyNow",
		label: "Why she wants to make a change right now",
	},
	{
		id: "lifeChange",
		label: "How her life would change by receiving this scholarship",
	},
	{
		id: "howItWouldFeel",
		label: "How it would feel to hit her health goals and show up better for her family",
	},
	{
		id: "whySelected",
		label: "Why she should be selected for the Mo Muscle Training Scholarship",
	},
];
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">${escapeHtml(children ?? "Not specified")}</div>
                </div>
                <div class="info-row">
